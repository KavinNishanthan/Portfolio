      ...
      <div className='max-w-4xl mx-auto'>
        {experiences.map((exp, idx) => (
          <motion.div
            ...
            className='relative'>
            {/* Timeline connector */}
            <div className='absolute left-8 top-0 bottom-0 w-px bg-linear-to-b from-accent/50 via-accent/20 to-transparent hidden md:block' />

            {/* Timeline dot with pulse */}
            <div className='absolute left-6.25 top-10 hidden md:flex flex-col items-center'>
              <span className='relative flex h-5.5 w-5.5'>
                ...
                <span className='relative inline-flex rounded-full h-5.5 w-5.5 border-4 border-bg-primary bg-linear-to-br from-accent to-secondary' />
              </span>
            </div>

            <div className='md:ml-20 glass-card-glow rounded-2xl overflow-hidden'>
              {/* Gradient top bar */}
              <div className={`h-1 bg-linear-to-r ${exp.color}`} />
